...
struct StartKeepAwakeIntent: AppIntent {
    ...
    static var description = IntentDescription("Keep your Mac awake, optionally for a set duration.")
    ...
    func perform() async throws -> some IntentResult {
        ...
        commander.startKeepAwake(duration: seconds)
        return .result()
    }
}
...
struct StopKeepAwakeIntent: AppIntent {
    ...
    static var description = IntentDescription("Turn off keep-awake.")
    @Dependency private var commander: SessionCommander

    @MainActor
    func perform() async throws -> some IntentResult {
        commander.stopKeepAwake()
        return .result()
    }
}

struct GetKeepAwakeStatusIntent: AppIntent {
    static var title: LocalizedStringResource = "Get Keep Awake Status"
    static var description = IntentDescription("Check whether Mara is keeping your Mac awake.")
    @Dependency private var commander: SessionCommander
